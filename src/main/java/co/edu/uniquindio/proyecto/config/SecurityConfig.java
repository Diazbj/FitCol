    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(req -> req
                                .requestMatchers("/swagger-ui/**", "/v3/api-docs/**", "/api/login/**","/api/usuarios/Activar","/api/usuarios", "/api/**").permitAll()
                                .requestMatchers("/api/cliente/**").hasAuthority("ROLE_CLIENTE")
                                .requestMatchers("/api/nutricionista/**").hasAuthority("ROLE_NUTRICIONISTA")
